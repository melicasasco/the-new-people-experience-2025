      ...
      <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-0 items-stretch bg-[#d42c2c] ">
          ...
          <div className="bg-[#D62828] text-white p-8 md:px-12 pt-10 flex flex-col md:mr-[80px] md:mt-16">
            ...
            >
              ...
              <Link
                href="/campaigns/category/childrens-day"
                className=" font-matahari font-black inline-block border border-white rounded-full px-6 pt-2 pb-1  hover:bg-white hover:text-[#D62828] transition-colors hover-scale md:text-[22px] text-[16px]"
              >
