  ...
  return (
    <section id="births" className=" overflow-hidden">
      <div className="w-full mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 bg-[#FFFC8A]">
          {/* Left side - Content */}
          <div className="bg-[#FFFC8A] p-8 md:p-12 flex flex-col justify-center md:ml-[80px]">
          <motion.div
          ...
          >
              ...
              <Link
                href="/campaigns/category/births"
                className="font-matahari font-black inline-block border border-black rounded-full mt-8 px-6 pt-2 pb-1 hover:bg-black hover:text-yellow-300 transition-colors hover-scale md:mr-[80px] md:text-[22px] text-[16px]"
              >
