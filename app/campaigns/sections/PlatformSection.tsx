      ...
      <div className="w-full mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch">
          ...
          >
              ...
              <p className="mb-0 font-poppings text-regular text-[16px] md:w-[70%] w-[90%]">
              Funciona como inbound para potenciar la propuesta de <span className="relative inline-block">
                valor al empleado
                <Image
                  src="/beneficios-underline.svg"
                  alt="Subrayado"
                  width={144}
                  height={24}
              ...
              <p className="mb-4 font-poppings text-regular text-[16px] mt-3 md:w-[70%] w-[90%]">
              ...
              <p className="mb-2 font-poppings text-regular text-[16px] md:w-[70%] w-[90%]">Eleva el engagement, con la activación de <span className="font-bold">campañas de beneficios flex.</span></p>
            </motion.div>
          </div>
