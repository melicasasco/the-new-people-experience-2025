...
function layout({ children }: { children: React.ReactNode }) {
    return (
        <div>
            ...
            <div
                className=
                "flex w-full md:py-4 py-6 flex-col md:gap-0 gap-[0px] md:flex-row md:items-center md:justify-between justify-center space-y-8 md:space-y-0 w-full px-[24px] md:px-[100px]"
            >
                ...
                <p className="order-3 inline-flex items-center gap-2">
                    ...
                    <a href="mailto:hello@bepeopleexperience.com" className="relative after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 hover:after:w-full after:bg-current after:transition-all after:duration-300"
                    >hello@bepeopleexperience.com</a> 
                </p>
            </div>
        </div>
    )
